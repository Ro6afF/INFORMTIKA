...
X2(TexStorage1D, TEXSTORAGE1D)
X2(TexStorage2D, TEXSTORAGE2D)
X2(TexStorage3D, TEXSTORAGE3D)
X2(TexSubImage3D, TEXSUBIMAGE3D)
X2(GenerateMipmap, GENERATEMIPMAP)
X2(TexParameteri, SAMPLERPARAMETERI)
X2(TexParameterf, SAMPLERPARAMETERF)
